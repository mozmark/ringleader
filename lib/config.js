...
const EVENT_ACTIVATED = "ConfigureSecProxyActivated";
const EVENT_STARTED = "ConfigureSecProxyStarted";
const EVENT_SUCCEEDED = "ConfigureSecProxySucceeded";
const EVENT_FAILED = "ConfigureSecProxyFailed";
const EVENT_CONFIGURE = "ConfigureSecProxy";
    ...
    if (domWindowUtils.isHandlingUserInput) {
      Setup.configure(event.detail.url).then(
          function(configInfo) {
            ...
            dispatchSetupEvent(doc, EVENT_SUCCEEDED,{});
          },
          function(errorInfo){
            //TODO: send EVENT_FAILED
            dispatchSetupEvent(doc, EVENT_FAILED,{});
          });
    } else {
